...
declare class DataSet extends BaseDataSet {
    static stylesheet(): string;
    get url(): string;
    fetch(): Promise<DatasetCursor>;
    render(p1: any, p2: any, p3: any): import("./tonic.js").TonicTemplate;
}
...
declare function fetchData(dataset_id: string): Promise<DatasetCursor>;
