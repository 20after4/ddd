...
var chart1 = createCommonjsModule(function(module, exports) {
    /*!
 * Chart.js v3.6.0
 ...
 */ (function(global, factory) {
        ...
        class Animator {
            _notify(chart2, anims1, date, type1) {
            ...
            listen(chart3, event1, cb) {
                this._getAnims(chart3).listeners[event1].push(cb);
            }
            add(chart4, items1) {
                if (!items1 || !items1.length) {
                    return;
                }
                this._getAnims(chart4).items.push(...items1);
            }
            has(chart5) {
                return this._getAnims(chart5).items.length > 0;
            }
            start(chart6) {
            ...
            stop(chart8) {
                const anims = this._charts.get(chart8);
                ...
                anims.items = [];
                this._notify(chart8, anims, Date.now(), 'complete');
            }
            remove(chart9) {
                return this._charts.delete(chart9);
            }
            constructor(){
                this._request = null;
 ...
 */ const map$1 = {
        ...
        class BasePlatform {
            ...
            addEventListener(chart12, type3, listener2) {
            }
            removeEventListener(chart11, type2, listener1) {
            }
            getDevicePixelRatio() {
                return 1;
            }
            getMaximumSize(element1, width1, height1, aspectRatio1) {
                width1 = Math.max(0, width1 || element1.width);
                height1 = height1 || element1.height;
                return {
                    width: width1,
        ...
        class BasicPlatform extends BasePlatform {
            acquireContext(item1) {
                return item1 && item1.getContext && item1.getContext('2d') || null;
            }
        ...
        class DomPlatform extends BasePlatform {
            ...
            addEventListener(chart15, type5, listener4) {
                this.removeEventListener(chart15, type5);
                ...
                const handler = handlers[type5] || createProxyAndListen;
                proxies[type5] = handler(chart15, type5, listener4);
            }
            removeEventListener(chart13, type4) {
                const proxies = chart13.$proxies || (chart13.$proxies = {
                });
        ...
        const interpolators = {
            ...
            color (from, to, factor) {
                const c0 = color2(from || transparent);
                const c1 = c0.valid && color2(to || transparent);
        ...
        class Animations {
            ...
            _animateOptions(target1, values6) {
                const newOptions = values6.options;
        ...
        class DatasetController {
            ...
            updateRangeFromParsed(range, scale2, parsed1, stack1) {
            ...
            updateElement(element6, index8, properties1, mode8) {
                if (isDirectUpdateMode(mode8)) {
                    Object.assign(element6, properties1);
                } else {
                    this._resolveAnimations(index8, mode8).update(element6, properties1);
                }
            }
            ...
            _setStyle(element2, index9, mode10, active3) {
                element2.active = active3;
                const options = this.getStyle(index9, active3);
                this._resolveAnimations(index9, mode10, active3).update(element2, {
                    options: !active3 && this.getSharedOptions(options) || options
                });
            }
            removeHoverStyle(element3, datasetIndex1, index10) {
                this._setStyle(element3, index10, 'active', false);
            }
            setHoverStyle(element4, datasetIndex2, index11) {
                this._setStyle(element4, index11, 'active', true);
            }
            ...
            updateElements(element5, start5, count5, mode11) {
            }
            ...
            _sync(args17) {
                if (this._parsing) {
                    this._syncList.push(args17);
                } else {
                    const [method, arg1, arg2] = args17;
                    this[method](arg1, arg2);
                }
            }
            _onDataPush() {
            ...
            constructor(chart16, datasetIndex3){
                this.chart = chart16;
                this._ctx = chart16.ctx;
        ...
        function autoSkip(scale, ticks) {
            ...
            if (numMajorIndices > 0) {
                ...
                for(i = 0, ilen = numMajorIndices - 1; i < ilen; i++){
                    skip1(ticks, newTicks, spacing, majorIndices[i], majorIndices[i + 1]);
                }
        ...
        class Scale extends Element {
            ...
            _callHooks(name3) {
                this.chart.notifyPlugins(name3, this.getContext());
                callback1(this.options[name3], [
                    this
                ]);
            }
            beforeDataLimits() {
            ...
            getLabelForValue(value3) {
                return value3;
            }
            getPixelForValue(value1, index13) {
                return NaN;
            }
            ...
            getLineWidthForValue(value2) {
                ...
                const ticks = this.ticks;
                const index = ticks.findIndex((t)=>t.value === value2
                );
                if (index >= 0) {
            ...
            getMatchingVisibleMetas(type10) {
                ...
                for(i = 0, ilen = metas.length; i < ilen; ++i){
                    const meta = metas[i];
                    if (meta[axisID] === this.id && (!type10 || meta.type === type10)) {
                        result.push(meta);
                    }
                }
                return result;
        ...
        class TypedRegistry {
            ...
            register(item3) {
                const proto = Object.getPrototypeOf(item3);
                let parentScope;
                ...
                if (!id) {
                    throw new Error('class does not have id: ' + item3);
                }
                if (id in items) {
                    return scope;
                }
                items[id] = item3;
                registerDefaults(item3, scope, parentScope);
                if (this.override) {
                    defaults1.override(item3.id, item3.overrides);
                }
                return scope;
            }
            get(id6) {
            ...
            constructor(type7, scope6, override1){
                this.type = type7;
                this.scope = scope6;
        ...
        class PluginService {
            notify(chart21, hook, args13, filter) {
                if (hook === 'beforeInit') {
                    this._init = this._createDescriptors(chart21, true);
                    this._notify(this._init, chart21, 'install');
                }
                const descriptors = filter ? this._descriptors(chart21).filter(filter) : this._descriptors(chart21);
                const result = this._notify(descriptors, chart21, hook, args13);
                if (hook === 'destroy') {
                    this._notify(descriptors, chart21, 'stop');
                    this._notify(this._init, chart21, 'uninstall');
                }
                return result;
            }
            _notify(descriptors, chart17, hook1, args14) {
                args14 = args14 || {
                };
            ...
            _descriptors(chart18) {
                if (this._cache) {
                    return this._cache;
                }
                const descriptors = this._cache = this._createDescriptors(chart18);
                this._notifyStateChanges(chart18);
                return descriptors;
            }
            _createDescriptors(chart19, all1) {
                const config = chart19 && chart19.config;
                const options = valueOrDefault(config.options && config.options.plugins, {
                });
                const plugins = allPlugins(config);
                return options === false && !all1 ? [] : createDescriptors(chart19, plugins, options, all1);
            }
            _notifyStateChanges(chart20) {
                ...
                ;
                this._notify(diff(previousDescriptors, descriptors), chart20, 'stop');
                this._notify(diff(descriptors, previousDescriptors), chart20, 'start');
            }
            constructor(){
                this._init = [];
            }
        ...
        class Config {
            ...
            set data(data5) {
                this._config.data = initData(data5);
            }
            get options() {
        ...
        class Chart {
            ...
            set options(options3) {
                this.config.options = options3;
            }
            _initialize() {
            ...
            getElementsAtEventForMode(e1, mode15, options4, useFinalPosition1) {
                const method = Interaction.modes[mode15];
                if (typeof method === 'function') {
                    return method(this, e1, options4, useFinalPosition1);
                }
                return [];
            }
            ...
            setDatasetVisibility(datasetIndex6, visible2) {
        ...
        class BarController extends DatasetController {
            parsePrimitiveData(meta10, data11, start19, count19) {
                return parseArrayOrPrimitive(meta10, data11, start19, count19);
            }
            parseArrayData(meta5, data6, start9, count9) {
                return parseArrayOrPrimitive(meta5, data6, start9, count9);
            }
            parseObjectData(meta6, data7, start10, count10) {
                const { iScale , vScale  } = meta6;
                const { xAxisKey ='x' , yAxisKey ='y'  } = this._parsing;
            ...
            updateRangeFromParsed(range1, scale6, parsed, stack) {
                super.updateRangeFromParsed(range1, scale6, parsed, stack);
            ...
            updateElements(bars, start11, count11, mode18) {
                const reset = mode18 === 'reset';
                const { index , _cachedMeta: { vScale  }  } = this;
                const base = vScale.getBasePixel();
                const horizontal = vScale.isHorizontal();
                const ruler = this._getRuler();
                const firstOpts = this.resolveDataElementOptions(start11, mode18);
                ...
                for(let i = start11; i < start11 + count11; i++){
                    ...
                    if (includeOptions) {
                        properties.options = sharedOptions || this.resolveDataElementOptions(i, bars[i].active ? 'active' : mode18);
                    }
                    const options = properties.options || bars[i].options;
                    setBorderSkipped(properties, options, stack, index);
                    setInflateAmount(properties, options, ruler.ratio);
                    this.updateElement(bars[i], i, properties, mode18);
                }
            }
            _getStacks(last1, dataIndex3) {
                const meta = this._cachedMeta;
                const iScale = meta.iScale;
                ...
                for(i = 0; i < ilen; ++i){
                    ...
                    if (typeof dataIndex3 !== 'undefined') {
                        const val = item.controller.getParsed(dataIndex3)[item.controller._cachedMeta.vScale.axis];
            ...
            _getStackCount(index21) {
                return this._getStacks(undefined, index21).length;
            }
            _getStackIndex(datasetIndex16, name2, dataIndex4) {
                const stacks = this._getStacks(datasetIndex16, dataIndex4);
                const index = name2 !== undefined ? stacks.indexOf(name2) : -1;
            ...
            _calculateBarValuePixels(index22) {
                ...
                if (this.chart.getDataVisibility(index22)) {
            ...
            _calculateBarIndexPixels(index23, ruler) {
                ...
                let center, size;
                if (ruler.grouped) {
                    const stackCount = skipNull ? this._getStackCount(index23) : ruler.stackCount;
                    const range = options.barThickness === 'flex' ? computeFlexCategoryTraits(index23, ruler, options, stackCount) : computeFitCategoryTraits(index23, ruler, options, stackCount);
                    const stackIndex = this._getStackIndex(this.index, this._cachedMeta.stack, skipNull ? index23 : undefined);
                    center = range.start + range.chunk * stackIndex + range.chunk / 2;
                    size = Math.min(maxBarThickness, range.chunk * range.ratio);
                } else {
                    center = scale.getPixelForValue(this.getParsed(index23)[scale.axis], index23);
        ...
        class BubbleController extends DatasetController {
            ...
            parsePrimitiveData(meta7, data8, start12, count12) {
                const parsed = super.parsePrimitiveData(meta7, data8, start12, count12);
                for(let i = 0; i < parsed.length; i++){
                    parsed[i]._custom = this.resolveDataElementOptions(i + start12).radius;
                }
                return parsed;
            }
            parseArrayData(meta8, data9, start13, count13) {
                const parsed = super.parseArrayData(meta8, data9, start13, count13);
                for(let i = 0; i < parsed.length; i++){
                    const item = data9[start13 + i];
                    parsed[i]._custom = valueOrDefault(item[2], this.resolveDataElementOptions(i + start13).radius);
                }
                return parsed;
            }
            parseObjectData(meta9, data10, start14, count14) {
                const parsed = super.parseObjectData(meta9, data10, start14, count14);
                for(let i = 0; i < parsed.length; i++){
                    const item = data10[start14 + i];
                    parsed[i]._custom = valueOrDefault(item && item.r && +item.r, this.resolveDataElementOptions(i + start14).radius);
                }
                return parsed;
            }
            getMaxOverflow() {
            ...
            getLabelAndValue(index24) {
                const meta = this._cachedMeta;
                const { xScale , yScale  } = meta;
                const parsed = this.getParsed(index24);
            ...
            update(mode19) {
                ...
                this.updateElements(points, 0, points.length, mode19);
            }
            updateElements(points2, start15, count15, mode20) {
                const reset = mode20 === 'reset';
                const { iScale , vScale  } = this._cachedMeta;
                const firstOpts = this.resolveDataElementOptions(start15, mode20);
                const sharedOptions = this.getSharedOptions(firstOpts);
                ...
                for(let i = start15; i < start15 + count15; i++){
                    ...
                    if (includeOptions) {
                        properties.options = this.resolveDataElementOptions(i, point.active ? 'active' : mode20);
                        if (reset) {
                            properties.options.radius = 0;
                        }
                    }
                    this.updateElement(point, i, properties, mode20);
                }
                this.updateSharedOptions(sharedOptions, mode20, firstOpts);
            }
            resolveDataElementOptions(index25, mode21) {
                const parsed = this.getParsed(index25);
                let values = super.resolveDataElementOptions(index25, mode21);
                if (values.$shared) {
        ...
        class DoughnutController extends DatasetController {
            ...
            parse(start16, count16) {
                ...
                if (this._parsing === false) {
                    ...
                    let getter = (i)=>+data[i]
                    ;
                    if (isObject(data[start16])) {
                        const { key ='value'  } = this._parsing;
                        getter = (i)=>+resolveObjectKey(data[i], key)
                        ;
                    }
                    let i, ilen;
                    for(i = start16, ilen = start16 + count16; i < ilen; ++i){
            ...
            update(mode22) {
                ...
                this.updateElements(arcs, 0, arcs.length, mode22);
            }
            ...
            updateElements(arcs, start17, count17, mode23) {
                const reset = mode23 === 'reset';
                const chart = this.chart;
                ...
                const firstOpts = this.resolveDataElementOptions(start17, mode23);
                const sharedOptions = this.getSharedOptions(firstOpts);
                const includeOptions = this.includeOptions(mode23, sharedOptions);
                ...
                for(i = start17; i < start17 + count17; ++i){
                    ...
                    if (includeOptions) {
                        properties.options = sharedOptions || this.resolveDataElementOptions(i, arc.active ? 'active' : mode23);
                    }
                    startAngle += circumference;
                    this.updateElement(arc, i, properties, mode23);
                }
                this.updateSharedOptions(sharedOptions, mode23, firstOpts);
            }
            calculateTotal() {
                const meta = this._cachedMeta;
            ...
            calculateCircumference(value4) {
                const total = this._cachedMeta.total;
                if (total > 0 && !isNaN(value4)) {
                    return TAU * (Math.abs(value4) / total);
                }
                return 0;
            }
            getLabelAndValue(index26) {
                const meta = this._cachedMeta;
                const chart = this.chart;
                const labels = chart.data.labels || [];
                const value = formatNumber(meta._parsed[index26], chart.options.locale);
                return {
                    label: labels[index26] || '',
                    value
                };
            }
            ...
            _getRingWeightOffset(datasetIndex12) {
                let ringWeightOffset = 0;
                for(let i = 0; i < datasetIndex12; ++i){
                    if (this.chart.isDatasetVisible(i)) {
            ...
            _getRingWeight(datasetIndex13) {
                return Math.max(valueOrDefault(this.chart.data.datasets[datasetIndex13].weight, 1), 0);
            }
            _getVisibleDatasetWeightTotal() {
                return this._getRingWeightOffset(this.chart.data.datasets.length) || 1;
            }
            constructor(chart22, datasetIndex14){
                super(chart22, datasetIndex14);
                this.enableOptionSharing = true;
        ...
        class LineController extends DatasetController {
            ...
            update(mode24) {
                ...
                this.updateElements(points, start, count, mode24);
            }
            updateElements(points1, start18, count18, mode25) {
                const reset = mode25 === 'reset';
                const { iScale , vScale , _stacked , _dataset  } = this._cachedMeta;
                const firstOpts = this.resolveDataElementOptions(start18, mode25);
                const sharedOptions = this.getSharedOptions(firstOpts);
                const includeOptions = this.includeOptions(mode25, sharedOptions);
                const iAxis = iScale.axis;
                const vAxis = vScale.axis;
                const { spanGaps , segment  } = this.options;
                const maxGapLength = isNumber(spanGaps) ? spanGaps : Number.POSITIVE_INFINITY;
                const directUpdate = this.chart._animationsDisabled || reset || mode25 === 'none';
                ...
                for(let i = start18; i < start18 + count18; ++i){
                    ...
                    if (includeOptions) {
                        properties.options = sharedOptions || this.resolveDataElementOptions(i, point.active ? 'active' : mode25);
                    }
                    if (!directUpdate) {
                ...
                this.updateSharedOptions(sharedOptions, mode25, firstOpts);
            }
            getMaxOverflow() {
                const meta = this._cachedMeta;
        ...
        class PolarAreaController extends DatasetController {
            getLabelAndValue(index27) {
                const meta = this._cachedMeta;
                const chart = this.chart;
                const labels = chart.data.labels || [];
                const value = formatNumber(meta._parsed[index27].r, chart.options.locale);
                return {
                    label: labels[index27] || '',
                    value
                };
            }
            update(mode26) {
                ...
                this._updateRadius();
                this.updateElements(arcs, 0, arcs.length, mode26);
            }
            _updateRadius() {
                const chart = this.chart;
                const chartArea = chart.chartArea;
            ...
            updateElements(arcs3, start21, count21, mode27) {
                const reset = mode27 === 'reset';
                const chart = this.chart;
                const dataset = this.getDataset();
                const opts = chart.options;
                const animationOpts = opts.animation;
                ...
                for(i = 0; i < start21; ++i){
                    angle += this._computeAngle(i, mode27, defaultAngle);
                }
                for(i = start21; i < start21 + count21; i++){
                    const arc = arcs3[i];
                    let startAngle = angle;
                    let endAngle = angle + this._computeAngle(i, mode27, defaultAngle);
                    ...
                    const properties = {
                        ...
                        startAngle,
                        endAngle,
                        options: this.resolveDataElementOptions(i, arc.active ? 'active' : mode27)
                    };
                    this.updateElement(arc, i, properties, mode27);
                }
            }
            ...
            _computeAngle(index30, mode28, defaultAngle) {
                return this.chart.getDataVisibility(index30) ? toRadians(this.resolveDataElementOptions(index30, mode28).angle || defaultAngle) : 0;
            }
            constructor(chart23, datasetIndex15){
                super(chart23, datasetIndex15);
                this.innerRadius = undefined;
                this.outerRadius = undefined;
            }
        }
        ...
        class RadarController extends DatasetController {
            getLabelAndValue(index29) {
                const vScale = this._cachedMeta.vScale;
                const parsed = this.getParsed(index29);
                return {
                    label: vScale.getLabels()[index29],
            ...
            update(mode29) {
                ...
                line.points = points;
                if (mode29 !== 'resize') {
                    const options = this.resolveDatasetElementOptions(mode29);
                    if (!this.options.showLine) {
                        options.borderWidth = 0;
                    }
                    const properties = {
                    ...
                    this.updateElement(line, undefined, properties, mode29);
                }
                this.updateElements(points, 0, points.length, mode29);
            }
            updateElements(points3, start20, count20, mode30) {
                const dataset = this.getDataset();
                const scale = this._cachedMeta.rScale;
                const reset = mode30 === 'reset';
                for(let i = start20; i < start20 + count20; i++){
                    const point = points3[i];
                    const options = this.resolveDataElementOptions(i, point.active ? 'active' : mode30);
                    ...
                    this.updateElement(point, i, properties, mode30);
                }
            }
        }
        ...
        class LineElement extends Element {
            updateControlPoints(chartArea, indexAxis1) {
                ...
                if ((options.tension || options.cubicInterpolationMode === 'monotone') && !options.stepped && !this._pointsUpdated) {
                    ...
                    _updateBezierControlPoints(this._points, options, chartArea, loop, indexAxis1);
        ...
        class PointElement extends Element {
            ...
            draw(ctx4, area1) {
                const options = this.options;
                if (this.skip || options.radius < 0.1 || !_isPointInArea(this, area1, this.size(options) / 2)) {
                    return;
                }
                ctx4.strokeStyle = options.borderColor;
                ctx4.lineWidth = options.borderWidth;
                ctx4.fillStyle = options.backgroundColor;
                drawPoint(ctx4, options, this.x, this.y);
            }
            getRange() {
                const options = this.options || {
                };
        ...
        class simpleArc {
            pathSegment(ctx6, bounds1, opts2) {
        ...
        function drawfill(ctx, source, area) {
            const target = getTarget1(source);
            ...
            _getLegendItemAt(x1, y1) {
                ...
                if (x1 >= this.left && x1 <= this.right && y1 >= this.top && y1 <= this.bottom) {
                    ...
                    for(i = 0; i < lh.length; ++i){
                        hitBox = lh[i];
                        if (x1 >= hitBox.left && x1 <= hitBox.left + hitBox.width && y1 >= hitBox.top && y1 <= hitBox.top + hitBox.height) {
        ...
        class Tooltip extends Element {
            ...
            _createItems(options13) {
                ...
                if (options13.filter) {
                    tooltipItems = tooltipItems.filter((element, index, array)=>options13.filter(element, index, array, data)
                    );
                }
                if (options13.itemSort) {
                    tooltipItems = tooltipItems.sort((a, b)=>options13.itemSort(a, b, data)
                    );
                }
            ...
            drawTitle(pt, ctx8, options16) {
                ...
                if (length) {
                    const rtlHelper = getRtlAdapter(options16.rtl, this.x, this.width);
                    ...
                    titleFont = toFont(options16.titleFont);
                    ...
                    for(i = 0; i < length; ++i){
                        ...
                        if (i + 1 === length) {
                            pt.y += options16.titleMarginBottom - titleSpacing;
                        }
                    }
                }
            }
            _drawColorBox(ctx9, pt1, i3, rtlHelper, options17) {
                ...
                const bodyFont = toFont(options17.bodyFont);
                ...
                if (options17.usePointStyle) {
                    ...
                    drawPoint(ctx9, drawOptions, centerX, centerY);
                ...
                ctx9.fillStyle = this.labelTextColors[i3];
            }
            drawBody(pt2, ctx10, options18) {
                const { body  } = this;
                const { bodySpacing , bodyAlign , displayColors , boxHeight , boxWidth , boxPadding  } = options18;
                const bodyFont = toFont(options18.bodyFont);
                let bodyLineHeight = bodyFont.lineHeight;
                let xLinePadding = 0;
                const rtlHelper = getRtlAdapter(options18.rtl, this.x, this.width);
            ...
            drawFooter(pt3, ctx11, options19) {
                ...
                let footerFont, i;
                if (length) {
                    const rtlHelper = getRtlAdapter(options19.rtl, this.x, this.width);
                    ...
                    footerFont = toFont(options19.footerFont);
            ...
            drawBackground(pt4, ctx12, tooltipSize, options20) {
                ...
                const { topLeft , topRight , bottomLeft , bottomRight  } = toTRBLCorners(options20.cornerRadius);
                ...
                if (yAlign === 'top') {
                    this.drawCaret(pt4, ctx12, tooltipSize, options20);
                }
            ...
            draw(ctx13) {
                ...
                if (options.enabled && hasTooltipContent) {
                    ...
                    overrideTextDirection(ctx13, options.textDirection);
                    pt.y += padding.top;
                    this.drawTitle(pt, ctx13, options);
                    this.drawBody(pt, ctx13, options);
                    this.drawFooter(pt, ctx13, options);
                    restoreTextDirection(ctx13, options.textDirection);
                    ctx13.restore();
                }
            }
            getActiveElements() {
            ...
            handleEvent(e4, replay4) {
                ...
                changed = replay4 || !_elementsEqual(active, lastActive) || positionChanged;
                if (changed) {
                    this._active = active;
        ...
        class CategoryScale extends Scale {
            parse(raw, index34) {
                ...
                index34 = isFinite(index34) && labels[index34] === raw ? index34 : findOrAddLabel(labels, raw, valueOrDefault(index34, raw));
            ...
            getLabelForValue(value7) {
                const labels = this.getLabels();
                if (value7 >= 0 && value7 < labels.length) {
                    return labels[value7];
                }
                return value7;
            }
            configure() {
        ...
        class LinearScaleBase extends Scale {
            ...
            getLabelForValue(value11) {
                return formatNumber(value11, this.chart.options.locale);
            }
            constructor(cfg8){
                super(cfg8);
        ...
        class LogarithmicScale extends Scale {
            ...
            getLabelForValue(value9) {
                return value9 === undefined ? '0' : formatNumber(value9, this.chart.options.locale);
            }
            configure() {
            ...
            getPixelForValue(value10) {
                if (value10 === undefined || value10 === 0) {
                    value10 = this.min;
                }
                if (value10 === null || isNaN(value10)) {
                    return NaN;
                }
                return this.getPixelForDecimal(value10 === this.min ? 0 : (log10(value10) - this._startValue) / this._valueRange);
            }
        ...
        class RadialLinearScale extends LinearScaleBase {
            ...
            getIndexAngle(index40) {
                ...
                return _normalizeAngle(index40 * angleMultiplier + toRadians(startAngle));
            }
            getDistanceFromCenterForValue(value13) {
                if (isNullOrUndef(value13)) {
                    return NaN;
                }
                const scalingFactor = this.drawingArea / (this.max - this.min);
                if (this.options.reverse) {
                    return (this.max - value13) * scalingFactor;
                }
            ...
            getPointPosition(index36, distanceFromCenter) {
                const angle = this.getIndexAngle(index36) - HALF_PI;
                return {
...
var auto = chart1;
var BubbleController1 = auto.BubbleController;
export default auto;
export { BubbleController1 as BubbleController };
